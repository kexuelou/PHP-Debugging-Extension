...
DebugExtensionInitialize(PULONG Version, PULONG Flags)
{
    ...
    *Flags = 0;
	...
	if ((Hr = DebugClient->QueryInterface(__uuidof(IDebugControl2),
		(void **)&DebugControl2)) == S_OK)
	{
		...
		DebugControl2->GetCurrentTimeDate(&g_DbgSessionTime);

		DebugControl2->Release();
